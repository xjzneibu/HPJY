...
iptables -I OUTPUT -m owner --uid-owner=$uid  -p tcp --dport 443 -d down.wefun.vip -j ACCEPT
iptables -I OUTPUT -m owner --uid-owner=$uid  -p udp --dport 443 -d down.wefun.vip -j ACCEPT
